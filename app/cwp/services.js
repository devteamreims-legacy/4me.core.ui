...
myCwp.$inject = ['$q', '$log', 'ApiUrls', '$http', 'errors', 'cwpInterceptor', 'status', '$cookies', '$rootScope'];
function myCwp($q, $log, ApiUrls, $http, errors, cwpInterceptor, status, $cookies, $rootScope) {
  var myCwp = {};
  var loadingPromise;
  var service = {};
  var endpoints = {};
